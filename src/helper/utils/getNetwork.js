const { tezos_connection: { TEZOS_TESTNET_GHOSTNET, TEZOS_TESTNET_HANGZHOU, TEZOS_TESTNET_GRANADANET, CONSEIL_TESTNET_HANGZHOU, CONSEIL_TESTNET_GRANADANET, TEZOS_MAINNET, CONSEIL_MAINNET } } = require("../../config/index")

function getActiveNetwork(_network) {
    switch (_network) {
        case TEZOS_TESTNET_GHOSTNET.NETWORK:
            return TEZOS_TESTNET_GHOSTNET.URL;
